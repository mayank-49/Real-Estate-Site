  ...
  return (
    ...
    >
      <section
        id="services"
        className={`${
          darkMode ? "dark bg-gray-800" : "bg-red-200"
          ...
          {service.map((item, index) => {
            return (
              <div
                data-aos="zoom-in"
                key={index}
                className="bg-white dark:bg-black h-[300px] px-8 py-16 flex flex-col justify-center items-start gap-4 rounded-xl border-b-[5px] border-red-600 hover:bg-red-300 cursor-pointer"
              >
                <div className="p-6 rounded-full bg-red-200">
                  <item.icon className="text-red-600 size-10 transform hover:scale-110 transition-transform duration-200 cursor-pointer " />
                </div>
